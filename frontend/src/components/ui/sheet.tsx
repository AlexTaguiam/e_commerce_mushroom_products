  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        // data-slot="sheet-content"  The class `data-[side=bottom]:data-ending-style:translate-y-[2.5rem]` can be written as `data-[side=bottom]:data-ending-style:translate-y-10`
        data-side={side}
        className={cn(
